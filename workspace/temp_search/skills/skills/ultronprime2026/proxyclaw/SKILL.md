...
- **Python SDK:** `pip install iploop-sdk[stealth]` — [pypi.org/project/iploop-sdk](https://pypi.org/project/iploop-sdk/)
- **Node.js SDK:** `npm install iploop` — [npmjs.com/package/iploop](https://npmjs.com/package/iploop)

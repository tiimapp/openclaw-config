...
name: scaffold-lite
version: 1.0.0
description: "Your agent. Configured to you. Remembers everything. Includes setup wizard, 30-day roadmap, 25 ready-to-use prompts, and pre-built memory files."
author: scaffoldworkspace
keywords: [workspace, memory, agents, openclaw, productivity, scaffold, setup, organization, hooks, soul]
metadata:
  openclaw:
    emoji: "🏗"
---

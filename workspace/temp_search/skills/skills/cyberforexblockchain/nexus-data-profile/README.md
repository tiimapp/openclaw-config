...
**Data Profiler** — Statistical profiling and quality assessment of datasets
...
```bash
clawhub install nexus-data-profile
```
...
- **$0.20** per request (paid in ADA via Masumi Protocol)
